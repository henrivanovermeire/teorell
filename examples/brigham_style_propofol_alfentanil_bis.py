#!/usr/bin/env python3
"""Brigham-style TIVA: propofol + alfentanil → Bouillon BIS via equipotency."""
...
def main() -> None:
    ...
    out = Path(__file__).with_name("brigham_style_propofol_alfentanil_bis.png")
    ...
    ax_c.set_title("BAS-style — Schnider + Scott alfentanil → Bouillon BIS")
